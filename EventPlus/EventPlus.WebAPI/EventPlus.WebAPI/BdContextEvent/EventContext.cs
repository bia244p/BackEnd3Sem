...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=EventPlus;Trusted_Connection=True;TrustServerCertificate=True", x => x.UseHierarchyId());

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ComentarioEvento>(entity =>
        {
            entity.HasKey(e => e.IdCometarioEvento).HasName("PK__Comentar__5B8CF82B9B57B66B");

            entity.Property(e => e.IdCometarioEvento).HasDefaultValueSql("(newid())");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__034EFC0410B1A378");
        ...
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__B771C0D89C2BA34B");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__50FB6F5D9853F86F");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__CDB3A3BEB664FA94");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062BB55102A1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9779DE2F06");

            entity.Property(e => e.IdUsuario).HasDefaultValueSql("(newid())");

            entity.HasOne(d => d.IdTipoUsuarioNavigation).WithMany(p => p.Usuarios).HasConstraintName("FK__Usuario__IdtIipo__68487DD7");
        });
